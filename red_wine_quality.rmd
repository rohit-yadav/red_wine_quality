...
ggpairs(wine,
        ...
        axisLabels = 'internal', columns = c('fixed.acidity','volatile.acidity',
...
Re-plotting the above plot. Like our earlier finding in plot matrix they do have a strong correlation.
...
As per metadata citric acid is used in small amount, it can add freshness and
flavour to the wine. However, it didn't have a strong effect on the wine
quality. This might justify the peak at 0.
...
ggplot(aes(x = alcohol, y = volatile.acidity),
  ...
  ggtitle("Valtile Acidity and Alcohol with Quality Category")
```
